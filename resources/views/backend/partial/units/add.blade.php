...
@section('main')
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <!--begin::Form-->
        <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('unit.store')}}">
            @csrf
                                ...
                                <div class="m-portlet__head-wrapper">
                                    <div class="m-portlet__head-caption">
                                        <div class="m-portlet__head-title">
                                            <span class="m-portlet__head-icon">
                                                <i class="la la-plus fa-2x m--font-primary"></i>
                                            </span>
                                    ...
                                    <div class="m-portlet__head-tools">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right save_option"  data-action="save_new" x-placement="bottom-start" style="cursor: pointer">
                        ...
                        <div class="m-portlet">
                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <textarea name="note" class="form-control m-input" id="unit_note" rows="3">{{old('note')}}</textarea>
                                </div>
                            </div>
